...
public class ComponentTreeMassage {
	...
	public static void removeComponent(final UIComponent component) {
	...
	public static void removeComponent(final String componentId) {
	...
	public static void removeDialogBox(final UIComponent component) {
	...
	public static void removeComponent(final Class componentClass) {
		XspQuery domQuery = new XspQuery();
	 ...
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public static void removeComponent(final Class componentClass, final UIComponent parentComponent) {
		XspQuery domQuery = new XspQuery();
	 ...
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public static void removeComponent(final Class componentClass, final String parentComponentId) {
		XspQuery domQuery = new XspQuery();
	...
	public static void addFirst(final UIComponent component) {
		TypedUtil.getChildren(component.getParent()).add(0, component);
	}

	public static void addLast(final UIComponent component) {
		TypedUtil.getChildren(component.getParent()).add(component);
	}

	public static void addBefore(final UIComponent component, final UIComponent beforeComp) {
	...
	public static void addBefore(final UIComponent component, final String beforeCompId) {
		XspQuery domQuery = new XspQuery();
	...
	public static void addAfter(final UIComponent component, final UIComponent afterComp) {
	...
	public static void addAfter(final UIComponent component, final String afterCompId) {
		XspQuery domQuery = new XspQuery();
	...
	public static void addToLocation(final UIComponent component, final Integer location) {
	...
	public static void moveToFirst(final UIComponent component) {
		List<UIComponent> siblings = TypedUtil.getChildren(component.getParent());
		if (!siblings.isEmpty()) {
	...
	public static void moveToLast(final UIComponent component) {
		List<UIComponent> siblings = TypedUtil.getChildren(component.getParent());
		if (!siblings.isEmpty()) {
			int movedCompIndex = siblings.indexOf(component);
			UIComponent movedComp = siblings.remove(movedCompIndex);
	...
	public static void moveToLocation(final UIComponent component, final Integer location) {
		List<UIComponent> siblings = TypedUtil.getChildren(component.getParent());
		if (!siblings.isEmpty()) {
			int movedCompIndex = siblings.indexOf(component);
			UIComponent movedComp = siblings.remove(movedCompIndex);
	...
	public static void moveToBefore(final UIComponent component, final UIComponent beforeComp) {
	...
	public static void moveToBefore(final UIComponent component, final String beforeCompId) {
		XspQuery domQuery = new XspQuery();
		UIComponent beforeComp = domQuery.byId(beforeCompId);
		if (beforeComp != null) {
			List<UIComponent> beforeCompSiblings = TypedUtil.getChildren(beforeComp.getParent());
	...
	public static void moveToAfter(final UIComponent component, final UIComponent afterComp) {
	...
	public static void moveToAfter(final UIComponent component, final String afterCompId) {
		XspQuery domQuery = new XspQuery();
		UIComponent afterComp = domQuery.byId(afterCompId);
		if (afterComp != null) {
			List<UIComponent> afterCompSiblings = TypedUtil.getChildren(afterComp.getParent());
	...
	public static void makeChild(final UIComponent movedComponent, final UIComponent destinationComponent) {
	...
	public static void makeChild(final UIComponent movedComponent, final String destinationComponentId) {
		XspQuery domQuery = new XspQuery();
	...
	public static void makeChild(final String movedComponentId, final String destinationComponentId) {
		XspQuery domQuery = new XspQuery();
	...
	private static void cloneAttributeValue(final UIComponent sourceComponent, final UIComponent destinationComponent, final Method getter, final Method setter) {
		if (getter != null) {
	...
	@SuppressWarnings("rawtypes")
	private static Method getGetter(final UIComponent component, final String propertyName, final Class propertyType) {
		Method result = null;
	...
	@SuppressWarnings("rawtypes")
	private static Method getBeanMethod(final Object bean, final String methodName, final Class propertyType) {
		Method result = null;
		try {
	...
	private static String getBeanMethodName(final String prefix, final String propertyName) {
		return prefix + propertyName.substring(0, 1).toUpperCase() + propertyName.substring(1);
	}

	@SuppressWarnings("rawtypes")
	private static Method getSetter(final UIComponent component, final String propertyName, final Class propertyType) {
		Method result = null;
	...
	public static void makeChild(final String movedComponentId, final UIComponent destinationComponent) {
		XspQuery domQuery = new XspQuery();
		UIComponent movedComponent = domQuery.byId(movedComponentId);
